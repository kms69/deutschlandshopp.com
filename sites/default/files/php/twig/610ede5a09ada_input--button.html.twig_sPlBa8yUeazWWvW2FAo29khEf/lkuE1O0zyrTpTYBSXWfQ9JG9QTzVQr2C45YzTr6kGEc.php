...
($context["icon"] ?? null) && ($context["icon_position"] ?? null)) &&  !($context["icon_only"] ?? null))) ? (("icon-" . $this->sandbox->ensureToStringAllowed(($context["icon_position"] ?? null), 30, $this->source))) : (""))];
  ...
  ";
    ...
    {
        return new Source("", "themes/contrib/bootstrap/templates/input/input--button.html.twig", "D:\\xampp\\htdocs\\hoshi\\themes\\contrib\\bootstrap\\templates\\input\\input--button.html.twig");
    }
